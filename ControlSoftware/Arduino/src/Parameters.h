...
const int expulse_freq_arr[] = {275}; // f = 16e6/(freq_no+1)
const double expulse_duration_arr[] = {80, 100, 120}; // pulse width in microseconds
const double expulse_amp = 1.2;

const int NUM_AVERAGES = 10;
const int NUM_ECHOS = 500; // number of times oscilloscope will be triggered during measurement
...
const long echo_delay_time = 3000;

const long echo_sample_time = 4000; 
